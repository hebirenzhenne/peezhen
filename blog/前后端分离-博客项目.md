...
1）FTP获取源码包 or 官网下载 tar.gz结尾的安装包
...
```python
		...
		2，MIDDLEWARE 中添加 corsheaders.middleware.CorsMiddleware
		   位置尽量靠前，官方建议 ‘django.middleware.common.Co mmonMiddleware’ 上方
...
- DELETE（DELETE）：从服务器删除资源。
  ...
  1，Django 版本 控制在 1.11.x  ；最好是 1.11.8

  2，中间件 'corsheaders.middleware.CorsMiddleware',  <- 注意末尾逗号

  3，jwt显红问题 ->  pycham中重新安装即可导入
